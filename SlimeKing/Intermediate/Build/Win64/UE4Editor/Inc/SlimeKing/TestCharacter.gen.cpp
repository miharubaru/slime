...
#include "SlimeKing/TestCharacter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SLIMEKING_API UClass* Z_Construct_UClass_ATestCharacter_NoRegister();
	SLIMEKING_API UClass* Z_Construct_UClass_ATestCharacter();
	ENGINE_API UClass* Z_Construct_UClass_ACharacter();
	UPackage* Z_Construct_UPackage__Script_SlimeKing();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_ATestCharacter_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_SlimeKing,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATestCharacter, 3034022549);
	template<> SLIMEKING_API UClass* StaticClass<ATestCharacter>()
	{
		return ATestCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATestCharacter(Z_Construct_UClass_ATestCharacter, &ATestCharacter::StaticClass, TEXT("/Script/SlimeKing"), TEXT("ATestCharacter"), false, nullptr, nullptr, nullptr);
